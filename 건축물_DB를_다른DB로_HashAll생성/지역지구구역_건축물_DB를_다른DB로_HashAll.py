...
# ---------------------------------------
TABLE_MAP = {
    "eais_08_지역지구구역_bcp": "tCollectorBuildingRegionDistrictSection",
}
...
def migrate_table(src_conn, dst_conn, src_table, dst_table):
    ...
    mapping = {
        ...
        'BuildingRegionDistrictSectionCd': None,
        'LotLocation': '대지_위치',
        ...
        'Block': '블록',
        'Lot': '로트',
        'RegionDistrictSectionClassCd': '지역지구구역_구분_코드',
        'RegionDistrictSectionClassCdName': '지역지구구역_구분_코드_명',
        'RegionDistrictSectionCd': '지역지구구역_코드',
        'RegionDistrictSectionCdName': '지역지구구역_코드_명',
        'MainFlag': '대표_여부',
        'EtcRegionDistrictSection': '기타_지역지구구역',
        'CreateDate': '생성_일자',
        'CreateDateTime': None,
