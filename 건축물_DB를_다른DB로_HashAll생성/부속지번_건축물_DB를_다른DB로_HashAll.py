...
# ---------------------------------------
TABLE_MAP = {
    "eais_09_부속지번_bcp": "tCollectorBuildingSubLot",
}
...
def migrate_table(src_conn, dst_conn, src_table, dst_table):
    ...
    mapping = {
        ...
        'SubLedgerTypeCd': '부속_대장_구분_코드',
        'SubLedgerTypeCdName': '부속_대장_구분_코드_명',
        'SubSiGuGunCd': '부속_시군구_코드',
        'SubLegalDongCd': '부속_법정동_코드',
        'SubLotType': '부속_대지_구분_코드',
        'SubMainLotNum': '부속_번',
        'SubSubLotNum': '부속_지',
        'SubSpecialLotName': '부속_특수지_명',
        'SubBlock': '부속_블록',
        'SubLot': '부속_로트',
        'SubEtcLot': '부속_기타_지번_명',
        'CreateDate': '생성_일자',
        'CreateDateTime': None,
