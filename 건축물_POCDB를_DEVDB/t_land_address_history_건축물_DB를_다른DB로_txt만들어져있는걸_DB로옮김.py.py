...
CSV_PATH = r"C:\folder\t_land_address_history_merged.txt"
TABLE_NAME = "t_land_address_history"

# 대용량 파일 처리를 위한 배치 크기 (크게 설정)
BATCH_SIZE = 5000  # 한 번에 처리할 행 수

# 체크포인트 파일 (마지막 성공한 누적 행 번호 저장)
CHECKPOINT_FILE = os.path.join(os.path.dirname(__file__), "t_land_address_history_checkpoint.txt")
