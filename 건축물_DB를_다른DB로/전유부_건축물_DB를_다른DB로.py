...
# ---------------------------------------
TABLE_MAP = {
    "eais_05_전유부_bcp": "tCollectorBuildingExclusiveUse",
}
...
if __name__ == "__main__":
    ...
    # 세션 타임아웃 설정 (1시간)
    with src_conn.cursor() as c:
        c.execute("SET SESSION wait_timeout=3600")
        c.execute("SET SESSION interactive_timeout=3600")
        c.execute("SET SESSION net_read_timeout=3600")
        c.execute("SET SESSION net_write_timeout=3600")
