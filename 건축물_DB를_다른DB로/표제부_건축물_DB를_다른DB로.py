...
# ---------------------------------------
TABLE_MAP = {
    "eais_03_표제부_bcp": "tCollectorBuildingTitle",
}
...
def migrate_table(src_conn, dst_conn, src_table, dst_table):
    ...
    mapping = {
        ...
        'HouseholdCnt': '가구_수',
        'BuildingHeight': '높이',
        'AboveGradeFloorCnt': '지상_층_수',
        'BelowGradeFloorCnt': '지하_층_수',
        'PassengerElevatorCnt': '승용_승강기_수',
        'EmergencyElevatorCnt': '비상용_승강기_수',
        'SubBuildingCnt': '부속_건축물_수',
        'SubBuildingArea': '부속_건축물_면적',
        'TotalBuildingGrossFloorArea': '총_동_연면적',
        'IndoorMechanicalParkingCnt': '옥내_기계식_대수',
        ...
        'SeismicDesignFlag': '내진_설계_적용_여부',
        'SeismicPerformance': '내진_능력',
        'CreateDate': '생성_일자',
