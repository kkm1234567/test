...
# ---------------------------------------
TABLE_MAP = {
    "eais_07_오수정화시설_bcp": "tCollectorBuildingSewageTreatmentPlant",
}
...
def migrate_table(src_conn, dst_conn, src_table, dst_table):
    ...
    mapping = {
        ...
        'BuildingSewageTreatmentPlantCd': None,
        'LedgerType': '대장_구분_코드',
        ...
        'WastewaterSystemCd': '형식_코드',
        'WastewaterSystemCdName': '형식_코드_명',
        'WastewaterSystemName': '기타_형식',
        'WastewaterCapacityCd': '단위_구분_코드',
        'WastewaterCapacityCdName': '단위_구분_코드_명',
        'CapacityPopulationEquivalent': '용량_인용',
        'CapacityCubicMeter': '용량_루베',
        'CreateDate': '생성_일자',
        'CreateDateTime': None,
